...
add_nonebot_plugin = plugin.on_command("nb.添加插件", "添加来自 NoneBot 商店的插件")
...
remove_nonebot_plugin = plugin.on_command(
    "nb.移除插件", "移除来自 NoneBot 商店的插件", aliases={"nb.删除插件", "nb.卸载插件"}
)
...
upgrade_nonebot_plugin = plugin.on_command(
    "nb.更新插件", "更新来自 NoneBot 商店的插件", aliases={"nb.升级插件"}
)
