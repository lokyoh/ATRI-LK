...
plugin = Service("更新").document("ATRI-LK的更新服务").type(Service.ServiceType.SYSTEM).version("0.1.1")
...
update = plugin.on_command(cmd="/测试更新", docs="目前处于测试阶段", permission=MASTER)
