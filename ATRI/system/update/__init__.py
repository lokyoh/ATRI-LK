...
plugin = Service("更新").document("ATRI-LK的更新服务").type(Service.ServiceType.SYSTEM).version("0.1.3")
...
update = plugin.on_command(cmd="/更新", docs="目前处于测试阶段且只适用于从git上clone的项目", permission=MASTER)
