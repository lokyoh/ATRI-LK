...
class SchedulerController:
    ...
    def add_job(self, func, name: str, trigger: str | BaseTrigger = 'date', **kwargs) -> SchedulerJob:
        """添加计划任务，使用方法同apscheduler"""
        ...
        job = SchedulerJob(func=job_func(func), trigger=trigger, id=f'{self.service}-{name}', **kwargs)
