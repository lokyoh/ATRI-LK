...
def check_achievement(achievement: AchievementData, fish_data, msg):
    for ach in achievements:
        if ach.name in achievement.achieve:
            continue
        achieve = ach.func(achievement, fish_data)
        if achieve:
...
def fishing_times_achi(times):
    def func(achievement: AchievementData, fish_data):
...
def load_achievements():
    ...
    def get_max_length(achievement: AchievementData, fish_data):
    ...
    def get_max_quality(achievement: AchievementData, fish_data):
