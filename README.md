...
> 被勾上的即已大致完成，但仍需优化。未被勾选的是暂时未完成但已经加入。计划中表示最近会进行开发。被划线的暂时不进行更新。
- [ ] lk插件主体
  - [x] LK插件专属的用户系统Part.1
  - [x] 签到系统
  - [x] 物品商店系统Part.1
...
请参考文档: [部署项目](https://lokyoh.github.io/ATRI-LK-docs/install/installation/)

## 📖 文档 | Documentation
所有公开的信息都可在 [ATRI-LK-docs](https://lokyoh.github.io/ATRI-LK-docs/) 获取. 使用 [VitePress](https://vitepress.dev/) 构建. 
...
[Kyomotoi](https://github.com/Kyomotoi): [ATRI](https://github.com/Kyomotoi/ATRI) 及其所有[贡献者](https://github.com/Kyomotoi/ATRI/graphs/contributors)
